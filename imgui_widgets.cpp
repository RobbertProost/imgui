...
static ImVec2           InputTextCalcTextSizeW(ImGuiContext* ctx, const ImWchar* text_begin, const ImWchar* text_end, const ImWchar** remaining = NULL, ImVec2* out_offset = NULL, bool stop_on_new_line = false, const float wrap_width = 0.0f, const bool keep_trailing_blanks = false);
static ImVec2           FindCharPosition(ImGuiContext* ctx, const ImWchar* text_begin, const ImWchar* char_position, const ImWchar* text_end, const float wrap_width);
...
static ImVec2 InputTextCalcTextSizeW(ImGuiContext* ctx, const ImWchar* text_begin, const ImWchar* text_end, const ImWchar** remaining, ImVec2* out_offset, bool stop_on_new_line, const float word_wrap_width, const bool keep_trailing_blanks)
{
    ImGuiContext& g = *ctx;
    ImFont* font = g.Font;
    const float line_height = g.FontSize;
    ...
    if (render_cursor || render_selection)
    {
...

        {
            ...
            if (render_selection)
            {
                ...
                ImVec2 selection_pos = FindCharPosition(&g, text_begin, selection_ptr, text_end, word_wrap_width);
